...
class MultiAgentEnvironment:
    def __init__(self, num_agents=4, world_size=10.0, communication_radius=3.0, max_episode_steps=200):
    ...
    def calculate_rewards(self):
        ...
        for i in range(self.num_agents):
            ...
            rewards[i] += -0.1 * dist_to_goal  # Negative distance reward
...
if __name__ == "__main__":
    ...
    # Create trainer
    trainer = MultiAgentTrainer(env, num_episodes=50)
